...
**1시간마다** 오늘(KST) 뉴스를 증분 수집하고, 이번 주 **주간 인사이트**를 초안 → 웹 검색 검증 후 갱신합니다. 노션은 저장소, **웹 대시보드**가 주 열람 화면입니다.
...
| 시각 | 실행 |
| ---- | ---- |
| **KST 00:00** | 오늘 날짜 데일리 토글 생성 → 오늘 0시~현재 수집 → 이번 주 인사이트 |
| KST 01:00–23:00 | 오늘 증분. 신규 없으면 주간 인사이트는 유지 |
...
│   ├── 📰 2026-09-09
│   └── 📊 주간 인사이트 · 2026-09-10 15:00 KST  ← 같은 토글을 덮어씀
└── 📊 2026-W38 …
```
